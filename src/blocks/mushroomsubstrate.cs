    ...
    public class MushroomSubBE : BlockEntity
    {
        ...
        public override void FromTreeAttributes(ITreeAttribute tree, IWorldAccessor worldAccessForResolve)
        {
            ...
            if(hasitem)
            {
                ...
                {
                    LensStoryMod.logger.Log(EnumLogType.Warning,string.Format("Substrate at {0},{1},{2} had a non-mushroom block/item [ID: {3}] in it! Bad! Setting to null...",Pos.X,Pos.Y,Pos.Z,mayshroom.Id));
                    growing = null;
